...
use Openphp\Console\Scheduling\Commands\ScheduleInitCommand;
use Openphp\Console\Scheduling\Commands\ScheduleListCommand;
use Openphp\Console\Scheduling\Commands\ScheduleRunCommand;
use Openphp\Console\Scheduling\Commands\ScheduleWorkCommand;
...
class Console
{
    ...
    {
        $this->appaction = (new Application('2.0'))
